...
#ifndef MYCOLORMEMOAPP_SWIFT_H
#define MYCOLORMEMOAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyColorMemoApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14MyColorMemoApp11AppDelegate")
...
SWIFT_CLASS("_TtC14MyColorMemoApp18HomeViewController")
@interface HomeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)tapAddButton;
- (void)didTapColorSettingButton;
...
@interface HomeViewController (SWIFT_EXTENSION(MyColorMemoApp)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface HomeViewController (SWIFT_EXTENSION(MyColorMemoApp)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC14MyColorMemoApp13MemoDataModel")
@interface MemoDataModel : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull text;
@property (nonatomic, copy) NSDate * _Nonnull recordDate;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class UITextView;

SWIFT_CLASS("_TtC14MyColorMemoApp24MemoDetailViewController")
...
@interface MemoDetailViewController (SWIFT_EXTENSION(MyColorMemoApp)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC14MyColorMemoApp13SceneDelegate")
